...
module.exports = (homebridge) => {
    ...
    homebridge.registerAccessory('homebridge-apcaccess', 'APCAccess', ContactSensor)
}
...
ContactSensor.prototype = {
    queryAPCAccess: function (callback) {
        this.client.getStatusJson()
            .then((result) => {
                let flags = result.STATFLAG;
                let value = [(flags & 0x08) ? 'CONTACT_DETECTED' : 'CONTACT_NOT_DETECTED'];
                this.contactSensor.setCharacteristic(Characteristic.ContactSensorState, value);
